// Manager/Products.jsx — re-uses same logic as admin Products but with manager permissions
...
const Products = () => {
  ...
  const handleSave = async (e) => {
    e.preventDefault();
    if (!form.name || !form.price || !form.category || (!form.stock && variantMatrix.length === 0)) { toast.error('Vui lòng điền đầy đủ thông tin'); return; }
    setSaving(true);
    try {
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-slide-up">
            ...
            <form onSubmit={handleSave} className="p-5 space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">Giá khuyến mãi</label>
