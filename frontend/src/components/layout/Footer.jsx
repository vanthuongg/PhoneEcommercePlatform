...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 pt-12 pb-8 transition-colors mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Banner tiện ích 4 cột */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pb-10 border-b border-gray-100 dark:border-gray-800">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="font-bold text-sm text-gray-900 dark:text-white">Giao hàng siêu tốc</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400">Miễn phí cho đơn từ 300k</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="font-bold text-sm text-gray-900 dark:text-white">Bảo hành chính hãng</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400">Cam kết 100% hàng thật</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="font-bold text-sm text-gray-900 dark:text-white">Đổi trả 30 ngày</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400">Hoàn tiền nếu không hài lòng</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="font-bold text-sm text-gray-900 dark:text-white">Hỗ trợ 24/7</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400">Hotline tư vấn miễn phí</p>
            </div>
          </div>
        </div>

        {/* Nội dung chính Footer */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 py-10 border-b border-gray-100 dark:border-gray-800">
          <div className="lg:col-span-2 space-y-4">
            <Link to="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-extrabold text-gray-900 dark:text-white">TechPhone</span>
            </Link>
          ...
          <div>
            <h4 className="font-bold text-sm uppercase text-gray-900 dark:text-white mb-4 tracking-wider">Về TechPhone</h4>
          ...
          <div>
            <h4 className="font-bold text-sm uppercase text-gray-900 dark:text-white mb-4 tracking-wider">Hỗ trợ khách hàng</h4>
            <ul className="space-y-2.5 text-sm text-gray-500 dark:text-gray-400">
          ...
          <div>
            <h4 className="font-bold text-sm uppercase text-gray-900 dark:text-white mb-4 tracking-wider">Thanh toán & Kết nối</h4>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-2.5 py-1 bg-gray-100 dark:bg-gray-800 rounded font-bold text-xs text-blue-600">VNPay</span>
              <span className="px-2.5 py-1 bg-gray-100 dark:bg-gray-800 rounded font-bold text-xs text-pink-600">MoMo</span>
              <span className="px-2.5 py-1 bg-gray-100 dark:bg-gray-800 rounded font-bold text-xs text-emerald-600">COD</span>
              <span className="px-2.5 py-1 bg-gray-100 dark:bg-gray-800 rounded font-bold text-xs text-indigo-600">Stripe</span>
            </div>
            <h4 className="font-bold text-sm uppercase text-gray-900 dark:text-white mb-3 tracking-wider">Mạng xã hội</h4>
            <div className="flex items-center gap-3">
              <a href="#" className="w-9 h-9 rounded-xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-blue-600 hover:bg-blue-600 hover:text-white transition-colors"><Facebook size={18} /></a>
              <a href="#" className="w-9 h-9 rounded-xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-pink-600 hover:bg-gradient-to-tr hover:from-amber-500 hover:to-pink-600 hover:text-white transition-all"><Instagram size={18} /></a>
              <a href="#" className="w-9 h-9 rounded-xl bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-red-600 hover:bg-red-600 hover:text-white transition-colors"><Youtube size={18} /></a>
            </div>
          </div>
        </div>
